...
function d($var, $die = false) {
	if (is_array($var) || is_object($var) || is_resource($var)) {//die('v');
		echo '<pre style="color:#800;font-weight:bold">';echo(gettype($var));echo":\n";print_r($var);echo '</pre>';
	} else {
		echo '<span style="color:#800;font-weight:bold">';
		 var_dump($var);
		echo '</span>';
	}
	if (!empty($die)) {
