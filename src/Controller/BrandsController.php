...
{
	public $mainModel = 'Brands';
	public $the_table = 'brands';
	public $the_entity = 'brand';
	public $the_entity_capital = 'Brand';
    ...
    public function index()
    {
		...
		$add_brand_title = 'Search '.$this->the_entity_capital.'s';

		$the_entity_result = $this->$theModel->newEntity();
		$this->set($this->the_entity, $the_entity_result);

		$this->set(compact('page_title','the_table','the_entity', 'add_brand_title', 'theModel'));
