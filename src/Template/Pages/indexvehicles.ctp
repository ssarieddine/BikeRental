    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col" class="listingHead"><?= $this->Paginator->sort('rent_price') ?></th>
                <th scope="col" class="listingHead"><?= $this->Paginator->sort('rented') ?></th>
                <th scope="col" class="listingHead"><?= $this->Paginator->sort('brand') ?></th>
                <th scope="col" class="listingHead"><?= $this->Paginator->sort('vehicletype') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= h('$'.$datanum->rent_price.'/day') ?></td>
                <td><?php 
				if (!empty($datanum->rented)){
					echo 'Yes';
				}else{
					echo 'No';
				}
				?></td>
                <td><?= h($datanum->brand->title) ?></td>
                <td><?= h($datanum->vehicletype->title) ?></td>
